<section class="w-full">
    ...
    <x-incident.layout>
        ...
        <ul class="absolute inset-x-0 top-0 z-10 justify-center w-full m-4 -translate-y-1/2 steps lg:steps-horizontal bg-base-100">
        ...
        {{-- STEP 1: Info Dasar --}}
        @if($currentStep == 1)
        <div class="grid grid-cols-1 gap-4 mt-8 space-y-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="flex flex-col-reverse gap-2 mt-2 mt-8 md:flex-row">
