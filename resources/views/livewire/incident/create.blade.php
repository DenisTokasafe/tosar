    ...
    <x-incident.layout>
        ...
        <div class="border collapse collapse-arrow bg-base-100 border-base-300">
            ...
            <div class="font-semibold collapse-title bg-linear-to-r/oklab from-success to-info text-base-content">
                ...
                <h3 class="text-base font-semibold">PART 1 <span class="badge badge-md badge-dash badge-success-constant">Detail Laporan</span></h3>
        ...
        <div class="border collapse collapse-arrow bg-base-100 border-base-300">
            ...
            <div class="font-semibold collapse-title bg-linear-to-r/oklab from-success to-info text-base-content">
                ...
                <h3 class="text-base font-semibold">PART 2 <span class="badge badge-md badge-dash badge-success-constant">Pihak Terlibat Langsung (Saksi, korban cedera, kontraktor, operator, dll.)</span></h3>
        ...
        <div class="border collapse collapse-arrow bg-base-100 border-base-300">
            ...
            <div class="font-semibold collapse-title bg-linear-to-r/oklab from-success to-info text-base-content">
                ...
                <h3 class="text-base font-semibold">PART 3 <span class="badge badge-md badge-dash badge-success-constant">Partisipan Investigasi</span></h3>
        ...
        <div class="border collapse collapse-arrow bg-base-100 border-base-300">
            ...
            <div class="font-semibold collapse-title bg-linear-to-r/oklab from-success to-info text-base-content">
                ...
                <h3 class="text-base font-semibold">PART 4 <span class="badge badge-md badge-dash badge-success-constant">PEEPO Investigation questions for identification of the incident factors</span></h3>
        ...
        <div class="border collapse collapse-arrow bg-base-100 border-base-300">
            ...
            <div class="font-semibold collapse-title bg-linear-to-r/oklab from-success to-info text-base-content">
                ...
                <h3 class="text-base font-semibold">PART 5 <span class="badge badge-md badge-dash badge-success-constant">Time Line dan Analisis Informasi</span></h3>
        ...
        <div class="border collapse collapse-arrow bg-base-100 border-base-300">
            ...
            <div class="font-semibold collapse-title bg-linear-to-r/oklab from-success to-info text-base-content">
                ...
                <h3 class="text-base font-semibold">PART 6 <span class="badge badge-md badge-dash badge-success-constant">Investigasi Kecelakaan (Daftar Checklist Mengacu pada TT-MGT-LMS-025A)</span></h3>
        ...
        <div class="border collapse collapse-arrow bg-base-100 border-base-300">
            ...
            <div class="font-semibold collapse-title bg-linear-to-r/oklab from-success to-info text-base-content">
                ...
                <h3 class="text-base font-semibold">PART 7 <span class="badge badge-md badge-dash badge-success-constant">Dokumentasi & Tindakan Perbaikan</span></h3>
        ...
        <div class="border collapse collapse-arrow bg-base-100 border-base-300">
            ...
            <div class="font-semibold collapse-title bg-linear-to-r/oklab from-success to-info text-base-content">
                ...
                <h3 class="text-base font-semibold">PART 8 <span class="badge badge-md badge-dash badge-success-constant">Kunci Pembelajaran</span></h3>
