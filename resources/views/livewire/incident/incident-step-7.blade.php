...
<fieldset class="p-3 mt-4 border shadow-md border-base-300 fieldset card bg-base-100">
    ...
    <div class="grid grid-cols-1 gap-6 mb-4 md:grid-cols-2">
        ...
        <div class="space-y-2">
            ...
            @error('visual_evidence.*')
            <div class="flex items-center gap-1 mt-1 text-xs italic font-medium text-error">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                </svg>
                <span>Format file salah! Pastikan semua file adalah gambar.</span>
            </div>
            @enderror
