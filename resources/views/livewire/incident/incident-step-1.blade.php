...
<div class="grid grid-cols-1 gap-2  mb-8 md:grid-cols-2 lg:grid-cols-3">
    ...
    @endif
    <x-form.department-contractor-selector model="deptCont" :departments="$departments" :contractors="$contractors" model_dept="departement_id" model_cont="contractor_id" :showDropdown="$showDropdown" :showContractorDropdown="$showContractorDropdown" />
