            ...
            <div class="w-60">
                <div class="join" wire:ignore x-data="{
                    ...
                    clearDate() {
                        ...
                        // Panggil updatedRangeDate agar filter terhapus di Livewire
                        $wire.call('updatedRangeDate', null);
                    }
                ...
                Livewire.hook('message.processed', () => initFlatpickr());" x-ref="wrapper">
                    ...
                    <button @click="clearDate()" class="btn btn-xs btn-neutral join-item" type="button"
