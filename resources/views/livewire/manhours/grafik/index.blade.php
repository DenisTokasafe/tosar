    ...
    function updateChart(payload) {
        ...
        var option_mp = {
            ...
            title: {
                ...
                left: 'center',
                textStyle: { color: darkTextColor } // Warna Judul
            },
            tooltip: {
                trigger: 'axis'
            },
            legend: {
                data: ['PT. MSM', 'PT. TTN', 'CONTRACTOR'],
                textStyle: { color: darkTextColor } // Warna Legend
            },
            grid: {
                left: '3%',
                right: '4%',
            ...
            xAxis: {
                ...
                data: payload.months,
                axisLine: {
                    lineStyle: { color: darkAxisLineColor } // Garis sumbu X
                },
                axisLabel: {
            ...
            yAxis: {
                type: 'value',
                axisLine: {
                    lineStyle: { color: darkAxisLineColor } // Garis sumbu Y
                },
                axisLabel: {
                    color: darkTextColor // Label sumbu Y
                },
                splitLine: {
                    lineStyle: { color: darkAxisLineColor + '40' } // Garis horizontal grid
                }
            },
            series: [{
                name: 'PT. MSM',
