            ...
            function updateChart(data) {
                ...
                var option = {
                    title: {
                        ...
                        subtext: 'Total Manhours per bulan (Filter: ' + ({{ $start_date }} ? '{{ $start_date }}' : 'Awal Tahun') + ' - ' + ({{ $end_date }} ? '{{ $end_date }}' : 'Akhir Tahun') + ')',
                    ...
                    tooltip: {
                        ...
                        formatter: function (params) {
                            ...
                            params.forEach(function(item) {
                                tooltip += item.marker + item.seriesName + ': ' + item.value.toLocaleString() + ' Jam<br/>';
                            });
                            return tooltip;
                        }
                    },
