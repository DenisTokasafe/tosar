    ...
    <x-manhours.layout>
        <form wire:submit.prevent="submit">
            ...
            <div class="grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3">
                <x-form.searchable-dropdown label="Lokasi" placeholder="Cari lokasi..." modelsearch="searchLocation" modelid="location_id" :options="$locations" :showdropdown="$showLocationDropdown" labelfield="name" required />
