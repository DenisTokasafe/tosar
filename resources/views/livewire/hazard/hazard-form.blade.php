                    ...
                    <div class="relative">
                        ...
                        @if ($showPelaporDropdown)
                            <template x-teleport="body">
                                <ul x-data
                                    x-effect="
                                    // Hitung ulang posisi setiap kali Livewire render ulang dropdown
                                    $nextTick(() => {
                            ...
                            {{ $errors->has('manualPelaporName') ? 'ring-1 ring-rose-500 focus:ring-rose-500 focus:border-rose-500' : '' }}" />
