                ...
                <div class="p-6 border-b border-gray-200 bg-gray-50">
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div class="space-y-4">
                            ...
                            <x-form.searchable-dropdown label="Lokasi / Location" required
                                modelsearch="searchLocation" :disabled="$isDisabled" modelid="location" :options="$locations"
                        ...
                        <div class="space-y-4">
                            <fieldset>
                                <input id="department" value="department" wire:model="deptCont"
                                    class="peer/department radio radio-xs radio-accent" type="radio"
                                ...
                                <input id="company" value="company" wire:model="deptCont"
                                    class="peer/company radio radio-xs radio-primary" type="radio"
                                    name="deptCont" />
                                <x-form.label for="company" class="peer-checked/company:text-primary"
                                    label="Kontraktor" required />

                                <div class="hidden peer-checked/department:block">
                                    {{-- Department --}}
                                    <div class="relative mb-1 ">
                                        <x-form.searchable-dropdown-without-label modelsearch="search"
                                            modelid="dept_cont" :disabled="$isDisabled" placeholder="Cari Departemen..."
                            ...
                            <x-form.input-text label="Area Kerja" model="area" placeholder="Area kerja..."
                                required />
                                        ...
                                        <div class="flex flex-col w-full">
                                            ...
                                            <div class="relative w-full">
                                                <x-form.searchable-select-advanced :disabled="$isDisabled"
                                                    ...
                                                    :showdropdown="$showDropdownPetugas[$index] ?? false" :manualMode="$manualActPelaporMode"
