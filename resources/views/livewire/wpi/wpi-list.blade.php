...
<div class="flex flex-col items-center justify-between gap-4 mb-6 md:flex-row">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="/wpi/form" class="text-xs uppercase btn btn-primary btn-sm">
                + Laporan Baru
            </a>
        </div>
    </div>
                ...
                @forelse ($reports as $report)
                    <tr class="transition-colors border-b hover:bg-gray-50">
                        ...
                        <td class="flex justify-center gap-2 p-3">
                            ...
                            <a href="/wpi/form/{{ $report->id }}" class="text-blue-500 btn btn-square btn-ghost btn-xs hover:bg-blue-50" title="Edit">
