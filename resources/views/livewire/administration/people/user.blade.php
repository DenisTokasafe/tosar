<section class="w-full">
    ...
    <x-tabs-relation.layout>
            ...
            <div class="flex items-center justify-between border-t border-l border-r rounded-t-lg border-neutral-200 dark:border-base-200 md:px-4 md:absolute md:inset-x-0 md:top-0 md:z-20 md:flex-row bg-base-100 md:inset-shadow-sm">
