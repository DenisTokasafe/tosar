    ...
    <form wire:submit="generateJadwal" class="space-y-6">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-6 card bg-base-100 border border-base-200 shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <div class="max-h-[400px] overflow-y-auto space-y-2 pr-1">
                            ...
                            <div class="p-2 bg-base-200/50 rounded-lg text-sm flex justify-between items-center">
                                <span class="truncate">
                            ...
                            <div class="text-center py-6 text-xs text-base-content/40 italic">
