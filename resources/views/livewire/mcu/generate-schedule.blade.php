                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <fieldset class="fieldset w-full">
                        ...
                        <input type="text" readonly id="schedule_date" wire:model="schedule_date" placeholder="Pilih Tanggal MCU"
                            class="w-full cursor-pointer input input-bordered input-xs focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all {{ $errors->has('schedule_date') ? 'input-error focus:ring-error/20' : '' }}"
