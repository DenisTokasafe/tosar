            ...
            <div class="space-y-6 lg:col-span-2">
                <div class="border shadow-sm card bg-base-100 border-base-200">
                    <div class="p-2 card-body md:p-4">
                        <h3
                            class="flex items-center gap-2 mb-3 text-base font-semibold md:text-lg md:mb-0 text-base-content/80">
                    ...
                    <div class="border shadow-sm card bg-base-100 border-base-200">
                        <div class="p-0 card-body md:p-4">
                            <div
                                ...
                                <div>
                                    <h3
                                        class="flex items-center gap-2 text-base font-semibold md:text-lg text-base-content">
                            ...
                            @error('participantsData')
                                <div class="py-2 mx-4 mb-4 text-sm alert alert-warning md:py-3 md:mx-0 rounded-xl">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="w-4 h-4 stroke-current shrink-0 md:h-5 md:w-5" fill="none"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div
                                class="md:overflow-x-auto md:border md:rounded-xl md:border-base-200 md:mb-2 bg-base-200/20 md:bg-transparent">
                                        ...
                                        <div class="block divide-y md:table-row-group divide-base-200 md:divide-y-0">
                                            @foreach ($employees as $employee)
                                                <div wire:key="row-emp-{{ $employee->id }}"
                                                    class="block md:table-row bg-base-100 p-4 md:p-0 md:hover:bg-base-200/40 transition-colors {{ isset($participantsData[$employee->id]['selected']) && $participantsData[$employee->id]['selected'] ? 'bg-primary/5 md:bg-primary/5 border-l-4 border-l-primary md:border-l-0' : '' }}">

                                                    <div
                                                        class="flex items-start gap-3 mb-3 md:table-cell md:pt-4 md:text-center md:align-top md:mb-0">
                                                        ...
                                                        <div class="flex-1 md:hidden">
                                                            ...
                                                            <div class="flex items-center gap-2 mt-1">
                                                                <div class="badge badge-ghost badge-sm text-[10px]">
                                                                    {{ $employee->department_name ?? 'Belum ada Dept' }}
                                                                </div>
                                                                <span
                                                                    class="text-[10px] text-base-content/60 font-mono">NIK:
                                                    ...
                                                    <div class="hidden pt-4 align-top md:table-cell">
                                                        <div
                                                            class="mb-1 font-medium badge badge-ghost badge-sm md:badge-md">
                                                    ...
                                                    <div
                                                        class="block pl-8 align-top md:table-cell md:pt-2 md:pb-3 md:pl-0">
                                                        @if (isset($participantsData[$employee->id]['selected']) && $participantsData[$employee->id]['selected'])
                                                            <div
                                                                class="w-full p-3 mt-1 space-y-3 border shadow-sm bg-base-100 border-base-300 rounded-xl animate-fade-in-down">
                                                                <div
                                                                    class="text-[10px] md:text-xs font-bold text-primary tracking-wide uppercase mb-1 flex items-center gap-1">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        class="w-3 h-3 md:h-4 md:w-4"
                                                                ...
                                                                <div class="flex flex-col gap-3">
                                                                    ...
                                                                    <div class="pt-3 mt-1 border-t border-base-200"
                                                                        ...
                                                                        <x-form.searchable-select-advanced
                                                                            ...
                                                                            :options="$deptHeads" :showdropdown="$showDeptHeadDropdown[
                                                                                $employee->id
                                                                            ] ?? false"
                                                                            :manualMode="$manualDeptHeadMode[
                                                                                $employee->id
                                                                            ] ?? false"
                                                                    ...
                                                                    <div class="pt-3 mt-1 border-t border-base-200"
                                                                        ...
                                                                        <x-form.searchable-select-advanced
                                                                            ...
                                                                            :options="$managers" :showdropdown="$showSupervisorDropdown[
                                                                                $employee->id
                                                                            ] ?? false"
                                                        ...
                                                        @else
                                                            <div
                                                                class="text-[10px] md:text-xs text-base-content/40 italic pt-1 md:pt-2">
                                                                Centang untuk atur notifikasi...</div>
                                                        @endif
                                                    </div>
                                                </div>
                                            @endforeach
                    ...
                    <div class="p-4 card-body">
                        ...
                        <div class="max-h-[400px] overflow-y-auto space-y-2 pr-1">
                            @foreach ($participantsData as $id => $data)
                                @if (isset($data['selected']) && $data['selected'])
                                    <div
                                        class="flex items-center justify-between p-2 text-sm rounded-lg bg-base-200/50 group">
                                        <span class="truncate">
                                            {{ $this->getEmployeeName($id) }}
                                        </span>

                                        <button type="button" wire:click="removeParticipant('{{ $id }}')"
                        ...
                        <div
                            ...
                            <button type="submit"
                                ...
                                <span wire:loading wire:target="generateJadwal"
                                    class="hidden ml-2">Memproses...</span>
                            </button>
                        </div>
                    </div>
                </div>
