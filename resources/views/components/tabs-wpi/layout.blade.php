            ...
            <div wire:ignore class="flex flex-col items-center justify-between gap-4 mb-6 md:flex-row">
                ...
                <div class="flex items-center gap-3">
                    @if (Route::is('wpi.list'))
                        <a href="{{ route('wpi.create') }}" class="text-xs uppercase btn btn-primary btn-xs">
                    ...
                    @endif
                    @if (Route::is('fire-inspection-list'))
                        <a href="{{ route('fire-inspection') }}" class="text-xs uppercase btn btn-primary btn-xs">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-plus-icon lucide-plus">
                                <path d="M5 12h14" />
